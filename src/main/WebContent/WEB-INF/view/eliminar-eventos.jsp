...
<h1>Usuarios</h1>
	...
	<form:form action="del" modelAttribute="eventos" method="GET" >
	      ...
	      <div class="">
			<form:form action="del" modelAttribute="eventos" method="GET">        
	        	  <form:hidden path="id"/>
		           ...
		           ¿Desea eliminar el evento?<strong data-name=""></strong>
		           
		           
		          <div class="modal-footer">
			        <button type="button" class="btn btn-secondary" onclick="window.location.href='/Examen-Web'; return false;">Cancelar</button>
			        <button type="submit" class="btn btn-primary" onclick="alerta()" >Eliminar</button>
			      </div>
	         </form:form>
	      </div>                                                           
        </table>
